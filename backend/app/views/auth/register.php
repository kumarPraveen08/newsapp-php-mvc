  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="<?=URLROOT?>/auth/register" method="post">
        ...
        <div class="input-group mb-3">
          <input type="password" name="repsd" class="form-control" placeholder="Retype password" required>
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
      ...
      <a href="<?=URLROOT?>/auth/login" class="text-center">I already have a membership</a>
    </div>
  </div>
</div>
