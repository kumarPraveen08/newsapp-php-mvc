                        ...
                        <div class="pagination">
                            <?php if($data['currentPage'] > 1) : ?>
                                <div class="echo-de-category-show-more-btn text-center">
                                    <a href="<?=URLROOT?>/posts?page=<?=$data['prevPage']?>" class="text-capitalize echo-py-btn">Previous Page</a>
                                </div>
                            <?php endif; ?>
                            <?php if($data['currentPage'] * $data['perPagePosts'] < $data['totalPosts']) : ?>
                                <div class="echo-de-category-show-more-btn text-center">
                                    <a href="<?=URLROOT?>/posts?page=<?=$data['nextPage']?>" class="text-capitalize echo-py-btn">Next Page</a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
